...
class FillPermissionsForCredential extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCredential constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.credential',
            'admin.credential.index',
            'admin.credential.create',
            'admin.credential.show',
            'admin.credential.edit',
            'admin.credential.delete',
            'admin.credential.bulk-delete',
        ]);
